...
You'll need the custom theme for everything to look right. Easiest way is HACS, then you also get updates.
...
1. Click the badge above, or in HACS open the menu (three dots, top right) → **Custom repositories**, paste this repo's URL and pick **Theme** as type.
2. Download it, then reload themes (**Developer tools → Actions → `frontend.reload_themes`**) or restart.
3. Select the Origami theme in your user profile settings.

**By hand**

1. Copy `themes/origami.yaml` from this repository into your Home Assistant `themes` folder.
2. Do a quick restart.
3. Select the Origami theme in your user profile settings.

Either way, if you don't have themes enabled yet, add this to your `configuration.yaml` once and restart:
