...
**Cards** • [Header](#header) • [Weather](#weather-card) • [Favorites](#favorites) • [Climate](#climate-overview) • [Rooms](#rooms) • [Navbar](#navbar)<br>
**Reference** • [Patterns & Tricks](#patterns--tricks) • [Theme Cheat Sheet](#theme-cheat-sheet) • [Status](#status)

<br>

## About

paper-buttons-row is simply perfect. No other card is as flexible while staying that straightforward and simple, and it loads pretty much instantly, faster than the HA default cards for some mysterious reason. This setup has been in daily use for several years now, and this page documents it in case someone wants to use it as inspiration.

The whole dashboard runs on two ideas: template sensors do the thinking and cards only display the result, and nothing on screen jumps around while loading. Both show up a lot in [Patterns & Tricks](#patterns--tricks).
...
> [!NOTE]
> All entity names are English examples. Rename them to whatever fits your home, here and in the cards.
...
Nothing moves around while the page loads. This is behind most of the unusual choices above.
